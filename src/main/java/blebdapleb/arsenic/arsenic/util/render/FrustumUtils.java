package blebdapleb.arsenic.arsenic.util.render;

import net.minecraft.client.MinecraftClient;
import net.minecraft.client.render.Frustum;
import net.minecraft.util.math.Box;
import net.minecraft.util.math.Vec3d;
import blebdapleb.arsenic.arsenic.mixin.AccessorFrustum;
import blebdapleb.arsenic.arsenic.mixin.AccessorWorldRenderer;
