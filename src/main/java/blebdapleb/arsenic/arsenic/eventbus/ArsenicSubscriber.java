...
public class ArsenicSubscriber {
	...
	public ArsenicSubscriber(Object target, String methodName, Class<? extends Event> eventClass) {
		this(target, MethodUtils.getAccessibleMethod(target.getClass(), methodName, eventClass), eventClass);
	}

	public ArsenicSubscriber(Object target, Method method) {
		this(target, method, getEvent(method));
	}

	public ArsenicSubscriber(Object target, Method method, Class<? extends Event> eventClass) {
		try {
	...
	public final boolean equals(Object obj) {
		if (obj instanceof ArsenicSubscriber) {
			ArsenicSubscriber that = (ArsenicSubscriber) obj;
