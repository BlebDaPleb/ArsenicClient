...
public class BindBox extends Component {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ArsenicLogger.info(InputUtil.fromKeyCode(keyDown, -1).getLocalizedText().getString());
        ...
        if (selected)
        {
            mc.textRenderer.drawWithShadow(matrices, keySet.getName() + ": " + name,
                    parent.parent.x + textOffset + 3.5f, parent.parent.y + parent.offset + offset + textOffset, Color.RED.getRGB());
